# <a id="environment-variables"></a> Umgebungsvariablen
...
## <a id="create-and-use-env-vars"></a> Erstellen und Verwenden von Umgebungsvariablen
...
## <a id="read-env-vars-in-python"></a> Umgebungsvariablen in Python lesen
...
## <a id="types-and-validation"></a> Typen und Validierung
...
## <a id="path-environment-variable"></a> `PATH` Umgebungsvariable
...
### <a id="installing-python-and-updating-the-path"></a> Installation von Python und Aktualisierung des `PATH`
